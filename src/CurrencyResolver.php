 ...
 *
 * Applies the priority order (explicit selection → session → cookie → optional
 * geo detection → base) and returns the first candidate that is present in the
 * selectable allow-list. Anything invalid, disabled or rate-less is skipped; the
 * base currency is the final fallback and is always considered selectable.
 */
