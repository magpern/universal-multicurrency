...
* Dynamic Gutenberg block `universal-multicurrency/currency-switcher` on the existing M17/M22 switcher engine
* Bounded switcher presence detection for proactive asset loading; render callback remains correctness backstop
* Site Editor / block-theme manual placement; global Display settings remain design authority
* Settings schema 7 unchanged; OrderSnapshot 5; PersistedKeys 10; no DB migration
